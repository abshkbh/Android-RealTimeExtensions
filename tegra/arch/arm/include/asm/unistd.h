...
#define __NR_get_process_count		(__NR_SYSCALL_BASE+382)
#define __NR_get_current_processes	(__NR_SYSCALL_BASE+383)
#define __NR_set_logging		(__NR_SYSCALL_BASE+384)
#define __NR_get_log			(__NR_SYSCALL_BASE+385)
